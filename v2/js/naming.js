...
function nameFor(cat){
  ...
  return ({chiesa:'Chiesa di '+n,cimitero:'Cimitero di '+n,monumento:'Monumento a '+n,municipio:'Palazzo '+n,
   ...
   biblioteca:'Biblioteca '+n,teatro:'Teatro '+n,giardino:'Giardino '+n,
